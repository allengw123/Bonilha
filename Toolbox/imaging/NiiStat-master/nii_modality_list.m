...
idx = 0;
file_list = strvcat('lesion','cbf','rest','i3mT1','i3mT2','fa','dti','md','ttp','mtt','cbv','dtifc','fmri','fmrib','alf','palf','fa_dki','md_dki','dax_dki','drad_dki','mk_dki','kax_dki','krad_dki','kfa_dki','vbm_gm','vbm_wm','smooth_vbm_gm','smooth_vbm_wm','vbm_gm_enantimorphic','vbm_wm_enantimorphic','smooth_vbm_gm_enantimorphic','smooth_vbm_wm_enantimorphic','vbm_gm_les','vbm_wm_les');
number_list='';
