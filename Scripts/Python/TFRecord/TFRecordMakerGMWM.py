...
def TFcreate(file):
    ...
    sbj_name = 'GMWM_'+os.path.basename(v_filename_GM).split("GM_")[1]
...
out_dir  = r'F:\PatientData\LargeSet_4_7\TFRecords\58Slices\TFRecords_LTLE_RTLE_T1_58SlicesGMWM'
