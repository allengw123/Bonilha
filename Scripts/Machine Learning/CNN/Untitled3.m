...
for m=1:numel(matter)
    ...
    for iter=1:5
        ...
        response_CF_train=categorical(sum([response_CF_train>0 response_CF_train>25 response_CF_train>50 response_CF_train>75],2));
        ...
        response_CF_test=categorical(sum([response_CF_test>0 response_CF_test>25 response_CF_test>50 response_CF_test>75],2));
        ...
        response_CF_val=categorical(sum([response_CF_val>0 response_CF_val>25 response_CF_val>50 response_CF_val>75],2));
        
        %%%%%%%%%%%% Train the network
        %%
        net=runcnnFC(total_img_train,response_train,total_img_val,response_val,response_CF_train,response_CF_val,total_img_test,response_test,response_CF_test);
%%
