...
data_path='C:\Users\allen\Box Sync\Eleni\Smoothed_Files_thr_0.2';
save_path='C:\Users\allen\Box Sync\Eleni\SVM_results_all\SVM_results';
mkdir(save_path);

patient_name={'Left TLE','Right TLE'};
patient_side={'left','right'};

whitematteratlas_path='C:\Users\allen\Box Sync\Eleni\Resliced Atlas\rJHU_WM_atlas';
greymatteratlas_path='C:\Users\allen\Box Sync\Eleni\Resliced Atlas\rJHU_altas';
