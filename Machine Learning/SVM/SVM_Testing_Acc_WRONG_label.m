datapath='C:\Users\bonilha\Documents\Project_Eleni\SVM_results_all\SVM_results_wrong_labels';
...
title('Left TLE - SVM Accuracies for each ROI - Shuffled Labels','Fontsize',25)
...
xlabel('Test Accuracy','Fontsize',20)
ylabel('# of models','Fontsize',20)
title('Right TLE - SVM Accuracies for each ROI - Shuffled Labels','Fontsize',25)
